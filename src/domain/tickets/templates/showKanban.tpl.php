    ...
    <div class="maincontentinner">
        ...
        <form action="" method="get" id="ticketSearch">
            ...
            <div class="filterBar <?php
                                    if ($searchCriteria['users'] == '' && $searchCriteria['milestone'] == '' && $searchCriteria['type'] == '') {
                                        echo "hideOnLoad";
                                    } ?>">
                ...
                ?>
                    ...
                    <div class="column" style="width:<?= $size ?>%;">
                        ...
                        <div class="contentInner <?php echo "status_" . $key; ?>">
                            <div>
                                <a href="javascript:void(0);" class="quickAddLink" id="ticket_new_link_<?= $key ?>" <?php if ($_SESSION['userdata']['role'] !== 'client') { ?>onclick="jQuery('#ticket_new_<?= $key ?>').toggle('fast'); jQuery(this).toggle('fast');" <?php } else {
                                                                                                                                                                                                                                                                        echo 'style="display:none;"';
                                                                                                                                                                                                                                                                    } ?>><i class="fas fa-plus-circle"></i> <?php echo $this->__("links.add_todo_no_icon"); ?></a>
                            ...
                            <?php foreach ($this->get('allTickets') as $row) { ?>
                                <?php if ($row["status"] == $key) { ?>
                                    ...
                                    <?php if ($_SESSION['userdata']['role'] !== 'client') {
                                        echo 'moveable';
                                    } ?> container" id="ticket_<?php echo $row["id"]; ?>">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li id="timerContainer-<?php echo $row['id']; ?>" class="timerContainer">
                                                                <a class="punchIn" href="javascript:void(0);" data-value="<?php echo $row["id"]; ?>" <?php if ($clockedIn !== false) {
                                                                                                                                                            echo "style='display:none;'";
                                                                                                                                                        } ?>><span class="iconfa-time"></span> <?php echo $this->__("links.start_work"); ?></a>
